...
#     # train(args)
#     print(args.utils_dir)
#     print(args.data_path)
#     print(args.batch_size)
#     print(args.seq_length)
#     print(args.init_from)
#     utils_dir=args.utils_dir
#     print(utils_dir is None)
#
# def train(args):
#     data_loader = TextLoader(args.utils_dir, args.data_path, args.batch_size, args.seq_length, None,
#                              None)
...
#                                            'config.pkl')), 'config.pkl file does not exist in path %s' % args.init_from
#         assert os.path.isfile(os.path.join(args.init_from,
#                                            'chars_vocab.pkl')), 'chars_vocab.pkl file does not exist in path %s' % args.init_from
#         assert os.path.isfile(os.path.join(args.init_from,
#                                            'labels.pkl')), 'labels.pkl file does not exist in path %s' % args.init_from
...
#                     [model.cost, model.final_state, model.optimizer, model.accuracy],
#                     feed_dict=feed)
#                 end = time.time()
...
if __name__ == '__main__':
    # main()
    with open('data/labels.pkl', 'r') as f:
